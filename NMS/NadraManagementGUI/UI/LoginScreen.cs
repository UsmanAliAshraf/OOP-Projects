...
namespace NadraManagementGUI
{
    public partial class LoginScreen : Form
    {
        ...
        {
            MUserDBCRUD.GetUsers();
            MUser user = ObjectHandler.GetUserDL().CheckValidation(txtUserName.Text, txtPassword.Text);
            if (user != null)
            {
                ...
                {
                    citizen c = CitizenDBCRUD.SearchCitizen(txtUserName.Text);
