...
namespace NadraManagementGUI
{
    public partial class frmSehatApp : Form
    {
        ...
        public void dataBind()
        {
            ...
            dataGridViewSahat.DataSource = citizenFHCRUD.SahatAppList;
        ...
        private void dataGridView1_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            if (dataGridViewSahat.Columns["Accept"].Index == e.ColumnIndex)
            {
                ...
                citizenFHCRUD.addSahatSelectedCitizen(person);
                citizenFHCRUD.deleteUserFromList(person);
                citizenFHCRUD.StoreIntoFileSahatApp(FilePath.sahatAppPath, FilePath.sahatSelectPath);
                dataBind();
